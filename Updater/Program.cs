...
namespace TrinityCreatorUpdater
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            c.DownloadFile(
                "https://github.com/Nadromar/TrinityCreator/blob/no-modelviewer/TrinityCreator/bin/Release/TrinityCreator.exe?raw=true",
                path);
        ...
        private static void DownloadAdditionalFiles(string exePath, int build)
        {
            ...
            using (WebClient c = new WebClient())
                for (int i = 0; i < newFiles.Count; i++)
                {
                    ...
                    c.DownloadFile("https://github.com/Nadromar/TrinityCreator/blob/no-modelviewer/TrinityCreator/bin/Release/" + newFiles[i] + "?raw=true",
                        dir + "\\" + newFiles[i]);
                }
        ...
        private static void Reinstall()
        {
            ...
            c.DownloadFile("https://github.com/Nadromar/TrinityCreator/blob/no-modelviewer/TrinityCreatorSetup/bin/Release/TrinityCreatorSetup.msi?raw=true",
            tempPath);
